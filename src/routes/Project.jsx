...
const projects = () => {
  ...
  return (
    <div className="py-[5rem]">
      ...
      <div className="relative mt-[5rem] border-2 border-violet-200 bg-white px-6  pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-7xl sm:rounded-lg sm:px-10">
        <div>
