...
import img1 from "../assets/mechatron.png";
...
const Navbar = () => {
  ...
  return (
    ...
    <div className="fixed top-0 left-0 z-10 w-screen bg-white text-black h-22">
    <div className=" items-center flex   md:justify-around py-5 mx-auto   font-bold text-black ">
      <div className="space-x-5 hidden lg:flex lg:gap-x-12 font-semibold leading-6 text-gray-900">
                  ...
                  {products.map((item) => (
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                        <item.icon
                          className="h-6 w-6 text-gray-500  group-hover:text-violet-800 "
                          aria-hidden="true"
                        />
                      </div>
      ...
      <div className="mx-auto md:mx-0">
        <img className=" h-24 w-24 " src={img1} alt="logo" />
      </div>

      <div className="flex  lg:hidden">
        <button
          type="button"
          className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 mr-10 text-gray-900"
      ...
      <div className=" hidden lg:flex lg:gap-x-12 text-lg font-semibold leading-6 text-gray-900 ">
